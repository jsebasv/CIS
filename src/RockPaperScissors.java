...
public class RockPaperScissors {
	...
	public static void main(String[] args) {
		...
		// Prints out the menu on the terminal window
		printMenu();
		
		// Prompt the user for an integer
		final int userSelection = promptUser();
		...
		if (userSelection == 1)
		{
			// User selected 1, check if they will beat the computer's selection:
			switch(computerNumber) {
				case 0:
				...
				default:
					System.out.println("Oops, something went ver wrong here...");
			}
